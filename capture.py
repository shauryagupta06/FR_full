...
folderPath =  "lecture_rec/"+folderName
...
#    dets = detector(img, 1)
    sampleNum += 1
    cv2.imwrite(folderPath + "/Lecture." + Id + "." + str(sampleNum) + ".jpg",
   ...
   #     cv2.rectangle(img, (d.left(), d.top())  ,(d.right(), d.bottom()),(0,255,0) ,2) # Forming the rectangle
    ...
    cv2.waitKey(1)
    if(sampleNum >= 3):                                                        # will take 20 faces
        break
...
import sys
for i in range(1,2):
 img_path='lecture_rec\lecture'+str(Id)+'\Lecture.'+str(Id)+'.'+str(i)+'.jpg'
 modeldir = './model/20170511-185253.pb'
 classifier_filename = './class/classifier.pkl'
 npy='./npy'
 train_img="./train2_img"
